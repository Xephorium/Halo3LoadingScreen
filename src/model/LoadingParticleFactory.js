 ...
 */
 ...
 class LoadingParticleFactory {
    ...
    initialize_active_particle (p, slice, particle) {
        ...
        p.position_initial[0] = p.position_final[0] + this.min_random() * .005 * angular_factor_x;
        p.position_initial[1] = p.position_final[1] + this.better_random() * .001;
        p.position_initial[2] = p.position_final[2] + this.min_random() * .005 * angular_factor_y;
        ...
        p.position_swerve[1] = swerve_base[1] - (this.better_random() * 0.00001);
